...
- **ליבה משותפת** (`js/core.js` + `js/catalog.json`): סכימת `phases`, `esc`, אחסון, `wa.me`, מנוע התוכנית, וקטלוג סרטונים אמיתיים (`file` = שם mp4). מנוע התוכנית בוחר ממאגר תרגילים נפרד — בלי שמות קובץ מזויפים.
